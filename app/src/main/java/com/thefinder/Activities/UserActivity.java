...
import com.thefinder.API.LocationResponse;
import com.thefinder.API.Response;
import com.thefinder.CustomDialogs.StoreLocationDialog;
...
public class UserActivity extends AppCompatActivity implements StoreLocationDialog.Communicator, Response.ResponseCommunicator, LocationResponse.LocationResponseCommunicator{
    ...
    @Override
    public void getLocationResponse(com.thefinder.DataModel.Location Location) {
